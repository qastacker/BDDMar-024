...
public class ExcelDataReader3 implements IDataReader {
	private final ExcelConfigr config;
	private Logger logger = LoggerFactory.getLogger(ExcelDataReader3.class);

	public ExcelDataReader3(ExcelConfigr config) {
		this.config = config;
	}
